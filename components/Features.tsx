      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        >
          ...
          <p className="sm:text-xl text-gray-400">
            We continuously work to improve our product, so you can focus on what matters most. Check out the latest features and updates.
          </p>
        </motion.div>
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          ...
          >
            ...
            <h3 className="mb-2 text-lg font-semibold text-white">Finance</h3>
            <p className="text-gray-400">
